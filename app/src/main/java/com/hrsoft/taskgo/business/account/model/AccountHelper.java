package com.hrsoft.taskgo.business.account.model;
...
public class AccountHelper extends BaseModel {
     ...
     * @param callback
     */
    public void checkToken(final IBaseContract.IBasePresenter presenter, final IDataCallback.Callback<String> callback) {
